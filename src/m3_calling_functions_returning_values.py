...
def fancy_sums_of_digits(n):
    ...
    x = n ** 1000
    y = n ** 999
    something = sum_of_digits(x)
    something_again = sum_of_digits(y)
    times = something ** something_again
    actual = sum_of_digits(times)
    return actual
